...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnApplyFilter" runat="server" OnClick="btnApplyFilter_Click" style="z-index: 1; left: 9px; top: 492px; position: absolute; width: 100px; height: 26px;" Text="Apply Filter" />
