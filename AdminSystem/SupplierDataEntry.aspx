...
<body>
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="TextBox1" runat="server" style="z-index: 1; left: 161px; top: 70px; position: absolute"></asp:TextBox>
        <asp:TextBox ID="TextBox2" runat="server" style="z-index: 1; left: 160px; top: 115px; position: absolute"></asp:TextBox>
        <p>
            &nbsp;</p>
        <asp:TextBox ID="TextBox3" runat="server" style="z-index: 1; left: 160px; top: 169px; position: absolute"></asp:TextBox>
        <p>
        ...
        <p>
            <asp:TextBox ID="TextBox4" runat="server" style="z-index: 1; left: 160px; top: 217px; position: absolute"></asp:TextBox>
        </p>
        ...
        <asp:TextBox ID="TextBox5" runat="server" style="z-index: 1; left: 157px; top: 269px; position: absolute"></asp:TextBox>
        ...
        <p>
            <asp:CheckBox ID="chkActive" runat="server" style="z-index: 1; left: 246px; top: 336px; position: absolute" Text="Active" />
        </p>
